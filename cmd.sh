...
python generating_spikes.py -refperiod 0.01 -rate 10 -timesim 200 -nbneurons 25000 -nbsegment 1 -outdir "." -namefile "input_pattern" -pattern -nbpattern 1 -patternsize 0.25 -patternfrequency 0.25 -sparsitypattern 1 -refpattern 1
python generating_spikes.py -refperiod 0.01 -rate 10 -timesim 200 -nbneurons 200 -nbsegment 1 -outdir "." -namefile "minimal_network_correction"
